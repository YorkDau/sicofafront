...
@Component({
  selector: 'app-consulta-apelaciones',
  templateUrl: './consulta-apelaciones.component.html',
  styleUrls: ['./consulta-apelaciones.component.scss'],
  providers: [DatePipe],
})
export class ConsultaApelacionesComponent implements OnInit {
...
@ViewChild(MatPaginator) paginator!: MatPaginator;
  ...
  public consultarCasos() {
    ...
    if (this.form.valid) {
      ...
      this.sharedService
        .consultarApelaciones(this.form.value)
        .subscribe({
