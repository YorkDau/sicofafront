  ...
  private modalMayorDias() {
    ...
    if (resultado > 10) {
      this.modales.modalExito(
        'Los tiempos establecidos legalmente para los procesos:VCF: 10 días siguientes a la presentación de la petición PARD: 6 meses para definir situación jurídica con posibilidad de prórroga.',
